...
```{r, include=TRUE}
WVS <- read.csv("WVS5.csv")
EVS <- read.csv("EVS2008.csv")
FH <- read.csv("FreedomHouse2017.csv")
```
...
names(WVS)<-names(EVS)
#before you merge, exam the two datasets again to make sure that they have the same variables and variable names 
names(WVS)
names(EVS)
